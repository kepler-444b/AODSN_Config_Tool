...
void ModelPanel2Key::SetPanelState(const QByteArray &data)
{
...
void ModelPanel2Key::on_key_1_clicked()
{
    ui->key_1->setChecked(!ui->key_1->isChecked()); // 状态回滚
    bulid_panel_frame(0);
}

void ModelPanel2Key::on_key_2_clicked()
{
    ui->key_2->setChecked(!ui->key_2->isChecked()); // 状态回滚
    bulid_panel_frame(1);
}

void ModelPanel2Key::bulid_panel_frame(const uint8_t key_num)
{
